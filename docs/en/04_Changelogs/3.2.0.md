...
By default "delete from live" and "delete from draft" actions are deprecated in favour of "unpublish" and "archive".
...
In order to remove the new "archive" action and restore the old "delete from draft" action you can use the following config
