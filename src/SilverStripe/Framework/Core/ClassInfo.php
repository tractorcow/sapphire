...
class ClassInfo {
	...
	public static function exists($class) {
		return ClassLoader::instance()->classExists($class);
	}
	...
	public static function subclassesFor($class) {
		$descendants = ClassLoader::instance()->getManifest()->getDescendantsOf($class);
	...
	public static function classImplements($className, $interfaceName) {
		return in_array($className, ClassLoader::instance()->getManifest()->getImplementorsOf($interfaceName));
	}
